 ...
 */
public class DrillTableFullEngine extends BaseQueryable<Object>
   ...
   */
  public DrillTableFullEngine(Schema schema,
                              Type elementType,
  ...
  private static DrillTableFullEngine createTable(
    ...
    return new DrillTableFullEngine(schema, Object.class, call, rowType, name,
  ...
  public RelNode toRel(RelOptTable.ToRelContext context, RelOptTable table) {
    return new DrillScanFullEngine(context.getCluster(),
  ...
  public static class Factory implements TableFactory<DrillTableFullEngine> {
    @Override
    public DrillTableFullEngine create(Schema schema, String name,
