...
public class TestDrillbitResilience extends ExecTest {
  ...
  public static void shutdownAllDrillbits() {
    ...
    if (remoteServiceSet != null) {
      Closeables.closeQuietly(remoteServiceSet);
   ...
   * query.
   */
  private void assertDrillbitsOk() {
   ...
   * @throws Exception
   */
  private void testForeman(final String desc) throws Exception {
  ...
  @Test
  public void testForemanRunTryBeginning() throws Exception {
  ...
  @Test
  @Ignore
  public void testForemanRunTryEnd() throws Exception {
