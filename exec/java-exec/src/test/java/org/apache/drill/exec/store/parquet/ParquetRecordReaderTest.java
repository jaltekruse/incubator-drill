...
//    batchLoader.clear();
  ...
  // requires binary file generated by pig from TPCH data, also have to disable asserts where data is coming in
...
//    };
    ...
    BufferAllocator allocator = new RootAllocator(c);
    for(int i = 0; i < 25; i++) {
