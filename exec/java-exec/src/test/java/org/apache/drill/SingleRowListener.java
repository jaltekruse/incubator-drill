 ...
 * such with a count(*) or limit 1. The abstract method {@see rowArrived()} provides
...
public abstract class SingleRowListener implements UserResultsListener {
  ...
  private final List<DrillPBError> errorList = new LinkedList<DrillPBError>(); // all errors ever received
