...
//      testByteArrayTransfer();
  ...
  // ============================================
  static final int numberGigs = 3;
  static final int iterations = 1024 * 1024 * numberGigs;
  static final int len = 1024;
  static final int transferLen = 32;
  static final TopLevelAllocator allocator = new TopLevelAllocator();
  static final int transfers = len / transferLen;
