...
public enum SystemTable {
  ...
  OPTION("options", false, OptionValueWrapper.class) {
    ...
    public Iterator<Object> getIterator(final FragmentContext context) {
      ...
      final Iterator<OptionValue> values = Iterators.concat(configOptions.iterator(), fragmentOptions.iterator());
      final Iterator<OptionValueWrapper> wrappers = new Iterator<OptionValueWrapper>() {
        @Override
        ...
        public OptionValueWrapper next() {
          final OptionValue value = values.next();
          final Status status;
      ...
      final Iterator<Object> iterator = (Iterator<Object>) (Object) wrappers;
      return iterator;
    }
  },
...
//  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(SystemTable.class);
  ...
  /**
   * Wrapper class to add status of the option
   */
