...
public final class ExecutionControls {
  ...
  /**
   * The JSON specified for the {@link org.apache.drill.exec.ExecConstants#DRILLBIT_CONTROLS_VALIDATOR}
  ...
  public ExecutionControls(final OptionManager options, final DrillbitEndpoint endpoint) {
    ...
    final String opString = options.getOption(ExecConstants.DRILLBIT_CONTROLS_VALIDATOR);
