...
public interface ExecConstants {
  ...
  public static BooleanValidator JSON_READ_NUMBERS_AS_DOUBLE_VALIDATOR = new BooleanValidator(
  ...
  public static BooleanValidator MONGO_READER_READ_NUMBERS_AS_DOUBLE_VALIDATOR = new BooleanValidator(
  ...
  public static final BooleanValidator ENABLE_WINDOW_FUNCTIONS = new BooleanValidator("exec.window.enable", false);

  public static final DoubleValidator DRILLBIT_CONTROLS_VALIDATOR =
