...
public class ExternalSortBatch extends AbstractRecordBatch<ExternalSort> {
  ...
  public ExternalSortBatch(final ExternalSort popConfig, final FragmentContext context,
      final RecordBatch incoming) throws OutOfMemoryException {
...
//          logger.debug("Took {} us to sort {} records", w.elapsed(TimeUnit.MICROSECONDS), count);
  ...
  private void createCopier(final VectorAccessible batch, final List<BatchGroup> batchGroupList,
      final VectorContainer outputContainer) throws SchemaChangeException {
    try {
      if (copier == null) {
