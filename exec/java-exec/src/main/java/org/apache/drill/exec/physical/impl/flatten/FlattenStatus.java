 ...
 */
public final class FlattenStatus {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(FlattenStatus.class);
  ...
  public FlattenBatch outputBatch;
  ...
  public FlattenStatus(RecordBatch left, RecordBatch right, FlattenBatch output) {
    super();
    this.left = left;
    this.right = right;
