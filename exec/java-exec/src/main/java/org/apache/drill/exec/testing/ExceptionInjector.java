 ...
 * of loggers).
 *
 * <p>See {@see package org.apache.drill.exec.testing.TestExceptionInjection} for examples of
 * use.
 */
public class ExceptionInjector {
  ...
  /**
   * Constructor. Classes should use the static {@see getInjector()} method to obtain
   * their injector.
   *
