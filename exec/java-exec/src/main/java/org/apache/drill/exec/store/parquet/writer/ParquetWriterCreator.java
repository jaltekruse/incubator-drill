 ...
 */
package org.apache.drill.exec.store.parquet.writer;
...
public class ParquetWriterCreator implements RootCreator<Screen> {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ParquetWriterCreator.class);
  ...
  public RootExec getRoot(FragmentContext context, Screen config, List<RecordBatch> children) {
    ...
    return new ParquetWriterRoot(context, children.iterator().next());
  }


  static class ParquetWriterRoot implements RootExec{
    static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ParquetWriterRoot.class);
    ...
    public ParquetWriterRoot(FragmentContext context, RecordBatch incoming){
