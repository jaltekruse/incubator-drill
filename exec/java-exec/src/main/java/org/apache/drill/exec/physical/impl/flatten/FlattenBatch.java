 ...
 */
public class FlattenBatch extends AbstractRecordBatch<FlattenPOP> {
  protected FlattenBatch(FlattenPOP popConfig, FragmentContext context) throws OutOfMemoryException {
...
//  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(FlattenBatch.class);
//
...
//  private final FlattenStatus status;
//  private final List<JoinCondition> conditions;
//  private final JoinRelType joinType;
//  private FlattenWorker worker;
//  public MergeJoinBatchBuilder batchBuilder;
//  private boolean done = false;
//
//  protected FlattenBatch(MergeJoinPOP popConfig, FragmentContext context, RecordBatch left, RecordBatch right) throws OutOfMemoryException {
//    super(popConfig, context);
//
...
//  }
//
//  private FlattenWorker generateNewWorker() throws ClassTransformationException, IOException, SchemaChangeException{
//
//    final ClassGenerator<FlattenWorker> cg = CodeGenerator.getRoot(FlattenWorker.TEMPLATE_DEFINITION, context.getFunctionRegistry());
...
//    JClass joinStatusClass = cg.getModel().ref(FlattenStatus.class);
