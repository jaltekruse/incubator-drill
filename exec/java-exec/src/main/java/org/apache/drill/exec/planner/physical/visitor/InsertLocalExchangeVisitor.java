...
public class InsertLocalExchangeVisitor extends BasePrelVisitor<Prel, Void, RuntimeException> {
  ...
  public Prel visitExchange(ExchangePrel prel, Void value) throws RuntimeException {
    ...
    if ( isMuxEnabled ) {
      ...
      final DrillSqlOperator sqlOpH = new DrillSqlOperator("hash", 1, MajorType.getDefaultInstance(), false);
      final DrillSqlOperator sqlOpX = new DrillSqlOperator("xor", 2, MajorType.getDefaultInstance(), false);
