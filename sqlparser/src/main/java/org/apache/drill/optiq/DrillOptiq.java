  ...
  private static class RexToDrill extends RexVisitorImpl<LogicalExpression> {
    ...
    public LogicalExpression visitCall(RexCall call) {
      ...
      case Special:
        ...
        /********************************
         * TODO - re-enable this
         * Cast was added to this enum in a later version of optiq, pulling in the new depedency
         * would neccesitate chaning a lot of code. We can re-enable this when the changes to
         * conform to the new optiq API are completed.
