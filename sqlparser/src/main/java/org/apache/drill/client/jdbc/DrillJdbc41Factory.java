...
public class DrillJdbc41Factory extends DrillFactory {
  ...
  public DrillJdbc41Connection newConnection(UnregisteredDriver driver, AvaticaFactory factory, String url,
      Properties info) {
  ...
  private static class DrillJdbc41Connection extends DrillConnectionImpl {
    DrillJdbc41Connection(Driver driver, AvaticaFactory factory, String url, Properties info) {
