...
//          ResultSet r = s.executeQuery("select cast(_MAP['RCOMMENT'] as varchar) from \"parquet\".\"/Users/jnadeau/region.parquet\"");
          ResultSet r = s.executeQuery("select R_REGIONKEY, cast(R_NAME as varchar) as region, cast(R_COMMENT as decimal(4,2)) as comment from parquet.`/Users/jnadeau/region.parquet`");
          boolean first = true;
          while (r.next()) {
